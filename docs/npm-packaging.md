...
状态：六包设计与 `0.2.0` lockstep 发布已完成；[发布证据](releases/npm-0.2.0.md)<br>
更新时间：2026-07-14<br>
...
| `@arcships/light-ocr-model-ppocrv6-small` | model | 完整 `ppocrv6-small-onnx-20260714.2` bundle、模型 license、可解析的 manifest subpath | facade 的普通 dependency |
