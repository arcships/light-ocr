  ...
  if(LIGHT_OCR_ONNXRUNTIME_FLAVOR STREQUAL "cpu")
    ...
    if(LIGHT_OCR_TARGET_LIBC STREQUAL "musl")
      if(CMAKE_SYSTEM_PROCESSOR MATCHES "^(x86_64|amd64|AMD64)$")
        ...
        set(_ort_musl_sha256 "a372c05947efdc67e76fcbdc9760f5b84a304c0556ea11da07f1dc3a9d9e3376")
      elseif(CMAKE_SYSTEM_PROCESSOR MATCHES "^(aarch64|arm64|ARM64)$")
        set(_ort_musl_arch "arm64")
        set(_ort_musl_sha256 "bbc8b4591002516cf45acb3f0bf1fb59219696b9efe9cf7a394b5ec104cb5579")
      else()
        message(FATAL_ERROR
